...
func internarPacienteComSucesso(t *testing.T, servico application.PacienteServico, pacienteId string, pacienteNome string, pacienteRaca string) {
...
func verificarPacienteInternado(t *testing.T, repo inmem.RepositorioemMemoriaPaciente, pacienteId string, pacienteNome string, pacienteRaca string) {
